...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["COPYING", "ext/ncurses/extconf.rb", "ext/ncurses/form_wrap.c", "ext/ncurses/form_wrap.h", "ext/ncurses/menu_wrap.c", "ext/ncurses/menu_wrap.h", "ext/ncurses/ncurses_wrap.c", "ext/ncurses/ncurses_wrap.h", "ext/ncurses/panel_wrap.c", "ext/ncurses/panel_wrap.h", "lib/ncurses/etc.rb", "lib/ncurses.rb", "README", "TODO"]
  s.files = ["Changes", "COPYING", "examples/example.rb", "examples/form.rb", "examples/form2.rb", "examples/hello_ncurses.rb", "examples/LICENSES_for_examples", "examples/rain.rb", "examples/read_line.rb", "examples/tclock.rb", "examples/test_scanw.rb", "ext/ncurses/extconf.rb", "ext/ncurses/form_wrap.c", "ext/ncurses/form_wrap.h", "ext/ncurses/menu_wrap.c", "ext/ncurses/menu_wrap.h", "ext/ncurses/ncurses_wrap.c", "ext/ncurses/ncurses_wrap.h", "ext/ncurses/panel_wrap.c", "ext/ncurses/panel_wrap.h", "lib/ncurses/etc.rb", "lib/ncurses.rb", "MANIFEST", "Rakefile.rb", "README", "THANKS", "TODO", "ncurses.gemspec"]
  s.has_rdoc = true
  s.homepage = %q{http://github.com/elliottcable/ncurses}
  s.rdoc_options = ["--line-numbers", "--inline-source", "--title", "Ncurses", "--main", "README"]
