...
Gem::Specification.new do |s|
  ...
  s.files = ["README.markdown", "Rakefile.rb", "examples/example.rb", "examples/form.rb", "examples/form2.rb", "examples/hello_ncurses.rb", "examples/license_notes.txt", "examples/rain.rb", "examples/read_line.rb", "examples/tclock.rb", "examples/test_scanw.rb", "ext/ncurses/extconf.rb", "ext/ncurses/form_wrap.c", "ext/ncurses/form_wrap.h", "ext/ncurses/menu_wrap.c", "ext/ncurses/menu_wrap.h", "ext/ncurses/ncurses_wrap.c", "ext/ncurses/ncurses_wrap.h", "ext/ncurses/panel_wrap.c", "ext/ncurses/panel_wrap.h", "lib/ncurses/etc.rb", "lib/ncurses.rb", "license.txt", ".manifest", "ncurses.gemspec"]
